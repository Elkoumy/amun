...
const FeatureCard5 = (props) => {
  return (
    <>
      <div className="feature-card5-feature-card">
        <svg viewBox="0 0 1024 1024" className="feature-card5-icon">
        ...
        <h2 className="feature-card5-text">{props.heading}</h2>
        <span className="feature-card5-text1">{props.text}</span>
      </div>
      <style jsx>
        {`
...
FeatureCard5.defaultProps = {
  heading: 'Risky User Traces Identification',
