"""
In this module we implement the Dimic's Algorithm to find the maximum flow in a graph.
source https://github.com/anxiaonong/Maxflow-Algorithms/blob/master/Dinic's%20Algorithm.py
"""
